...
from app.models.database import Document, ProcessingRun, DocumentBlock, MetadataProfile
...
def run_pipeline(temp_file_path: str, document_id: uuid.UUID):
    ...
    try:
        ...
        db_profile = MetadataProfile(
            ...
            text_area_ratio=metadata_profile_data.get("text_area_ratio"),
            image_area_ratio=metadata_profile_data.get("image_area_ratio"),
